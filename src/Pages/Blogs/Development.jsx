                ...
                <div className='mx-auto max-w-4xl px-8 sm:px-0'>
                    <motion.div initial={{ opacity: 0, translateY: 30 }} animate={{ opacity: 1, translateY: 0 }} transition={{ delay: 0.3 }}>
                        ...
                        <div className='flex gap-4 mt-5 items-center'>
                            <img className='rounded-full w-6' src="https://i.ibb.co/Z14JPtq/image.png" alt="hectorluez" />
                            <span><span onClick={() => navigate("/")} className='cursor-pointer hover:text-altindigo duration-300'>hectorluez</span> • published on 02-07-2023 • 2 min read</span>
                        </div>
                    </motion.div>
