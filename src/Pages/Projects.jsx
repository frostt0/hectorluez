...
const Projects = () => {
  ...
  const projects = [
    { icon: `fa-solid fa-earth-europe`, title: "hectorluez", description: "The website you're currently on! Made with React and utilises serverless functions.", url: "https://hectorluez.vercel.app/" },
  ]
